function [status, variable_read] = read_nc_variable( orbit_filename, variableName, month, year, data_dir, iBadOrbit, badOrbits, failure_mode, Time_of_orbit_extracted_from_title, fileOrbitNumber, variableRead)
