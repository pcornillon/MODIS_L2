function [status, start_line_index, imatlab_time, orbit_scan_line_times, num_scan_lines_in_granule] = ...
...
while imatlab_time <= Matlab_end_time
    ...
    [status, start_line_index, scan_line_timesT, missing_granule, num_scan_lines_in_granule, imatlab_time] ...
        = get_metadata( 1, metadata_directory, imatlab_time);
