% generate_separations - Generate the separation fields and angles needed to determine gradient east and north - PCC
%
% Canonical separations and anlges are generated for MODIS in a three step
...
month_list = dir(base_dir_orbital_data);

%% Do first iteration over separations and only iteration over angles.

seps_and_angles_filename_1 = [base_dir 'Data/mean_seps_and_angles_pass_1.mat'];
...
if do_first_iteration
    ...
    for iMonth=month_start:length(month_list)
...
seps_and_angles_filename_2 = [base_dir 'Data/mean_seps_and_angles_pass_2.mat'];
...
if do_final_smoothing
    ...
    save([base_dir 'Data/auxillary_seps_and_angles.mat'], 'along_scan_seps_1st', 'along_scan_seps', ...
