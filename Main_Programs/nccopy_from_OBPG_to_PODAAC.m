...
% If running on macstudio, we only have daytime data.
...
for idaynight=1:length(day_night)
    
    fprintf('\n\n**************\n Working on %s \n\n', convertCharsToStrings(day_night{idaynight}))
    ...
    for iYear=1:length(year_list) % Loop over years to process ......................................
        ...
        file_list = dir([ base_dir_in, day_night{idaynight} '/' YearS '/AQUA*.nc']);
