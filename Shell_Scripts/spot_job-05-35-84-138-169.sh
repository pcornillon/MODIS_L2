...
sudo -u ubuntu bash -c '
  ...
  nohup matlab -batch "prj=openProject('\''$REMOTE_MATLAB_PROJECT_DIRECTORY/MODIS_L2.prj'\''); AWS_batch_05_from_01_2022_to_06_20024;" > "$REMOTE_OUTPUT_DIRECTORY/$FILENAME" 2>&1 &
