...
sudo -u ubuntu bash -c '
  ...
  nohup matlab -batch "prj=openProject('\''$REMOTE_MATLAB_PROJECT_DIRECTORY/MODIS_L2.prj'\''); AWS_batch_06_from_12_2005_to_12_2009;" > "$REMOTE_OUTPUT_DIRECTORY/$FILENAME" 2>&1 &
