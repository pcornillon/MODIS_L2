...
sudo -u ubuntu bash -c '
  ...
  nohup matlab -batch "prj=openProject('\''$REMOTE_MATLAB_PROJECT_DIRECTORY/MODIS_L2.prj'\''); AWS_batch_07_from_1_2006_to_12_2016;" > "$REMOTE_OUTPUT_DIRECTORY/$FILENAME" 2>&1 &
