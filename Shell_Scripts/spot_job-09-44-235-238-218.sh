...
sudo -u ubuntu bash -c '
  ...
  nohup matlab -batch "prj=openProject('\''$REMOTE_MATLAB_PROJECT_DIRECTORY/MODIS_L2.prj'\''); AWS_batch_09_from_10_2020_to_12_2022;" > "$REMOTE_OUTPUT_DIRECTORY/$FILENAME" 2>&1 &
