...
echo "Directory structure created for temporary storage of orbit output files and ownership set to ubuntu." 2>&1 | tee -a "${LOCAL_OUTPUT_DIRECTORY}/local_session_log_35_84_138_169.txt"
