...
nohup matlab -nodisplay -nosplash -nodesktop -r "prj=openProject('/Users/petercornillon/Git_repos/MODIS_L2/MODIS_L2.prj'); disp('Starting AWS_batch_test'); AWS_batch_test; disp('Finished AWS_batch_test'); exit" > "/Users/petercornillon/Logs/local_test_1" 2>&1 | tee -a "$/Users/petercornillon/Logs/tester_session_log.txt"
