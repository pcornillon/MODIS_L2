% AWS_batch_02_from_01_2010_to_12_2013 - Batch job to run build_and_fix_orbits at AWS - PCC 
%
...
% 
% Versions.
%   1.0.0 - 8/27/2024 - initial version to process from 01/01/2010 in steps 
%           of 1 month, but submitting 48 jobs to take the processing through
%           December 2013. Currently designed to run on x2idn.16xlarge.
%           This computer has 64 virtural cores and 1.9 TB of main memory,
%           so Matlab will default to 32 jobs at once - PCC

global version_struct

version_struct.AWS_batch_02_from_01_2010_to_12_2013 = '1.0.0';
...
start_time = [2010 1 01 0 0 0];   % This is the start date/time the batch jobs are to use as [yyyy mm dd hh min ss]
