% AWS_batch_03_from_01_2014_to_12_2017 - Batch job to run build_and_fix_orbits at AWS - PCC 
%
...
% 
% Versions.
%   1.0.0 - 8/27/2024 - initial version to process from 01/01/2014 in steps 
%           of 1 month, but submitting 48 jobs to take the processing through
%           December 2017. Currently designed to run on x2idn.16xlarge.
%           This computer has 64 virtural cores and 1.9 TB of main memory,
%           so Matlab will default to 32 jobs at once - PCC

global version_struct

version_struct.AWS_batch_03_from_01_2014_to_12_2017 = '1.0.0';
...
start_time = [2014 1 01 0 0 0];   % This is the start date/time the batch jobs are to use as [yyyy mm dd hh min ss]
