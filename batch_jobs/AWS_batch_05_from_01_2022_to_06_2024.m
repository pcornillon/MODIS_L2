% AWS_batch_05_from_01_2022_to_06_2024 - Batch job to run build_and_fix_orbits at AWS - PCC 
%
...
% 
% Versions.
%   1.0.0 - 8/27/2024 - initial version to process from 01/01/2022 in steps 
%           of 1 month, but submitting 30 jobs to take the processing through
%           June 2024. Currently designed to run on x2idn.16xlarge.

global version_struct

version_struct.AWS_batch_05_from_01_2022_to_06_2024 = '1.0.0';
...
start_time = [2022 1 01 0 0 0];   % This is the start date/time the batch jobs are to use as [yyyy mm dd hh min ss]
...
num_batch = 30; % The number of batch jobs to submit
