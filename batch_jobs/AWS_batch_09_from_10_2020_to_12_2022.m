% AWS_batch_09_from_10_2020_to_12_2022 - Batch job to run build_and_fix_orbits at AWS - PCC 
%
...
% 
% Versions.
%   1.0.0 - 9/6/2024 - This will process on x2idn.16xlarge. This computer has
...
version_struct.AWS_batch_09_from_10_2020_to_12_2022 = '1.0.0';
...
start_time = [2020 10 01 0 0 0];   % This is the start date/time the batch jobs are to use as [yyyy mm dd hh min ss]
...
num_batch = 26; % The number of batch jobs to submit
