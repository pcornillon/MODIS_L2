% AWS_batch_35_84_138_169 - Batch job to run build_and_fix_orbits on 35.84.138.169 at AWS - PCC 
%
...
%   2.0.0 - 6/4/2024 -  Hopefully this will allow 45 batch jobs to run
%           simultaneously. Each core will process 20 days of data starting
%           on 05-Oct-2007 for a total of 960 days, about 2 1/2 years. Thes
%           last 20 day interval is from 02-May-2010 to 22-May-2010
...
%   2.0.2 - 8/11/2024 - Modified to switch to x2iedn.24xlarge processing.
%           Starting from 1/1/2009. Submitting 72 jobs to process 6 years.
%           - PCC

global version_struct

version_struct.AWS_batch_35_84_138_169 = '2.0.2';
...
start_time = [2009 1 1 0 0 0];   % This is the start date/time the batch jobs are to use as [yyyy mm dd hh min ss]
...
num_batch = 72; % The number of batch jobs to submit
