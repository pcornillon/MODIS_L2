...
start_time = [2016 12 1 0 0 0];   % This is the start date/time the batch jobs are to use as [yyyy mm dd hh min ss]
...
num_batch = 20; % The number of batch jobs to submit
